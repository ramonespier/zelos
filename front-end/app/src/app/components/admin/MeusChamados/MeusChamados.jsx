...
export default function MeusChamados() {
    ...
    return (
        <>
            ...
            >
                <div className="max-h-150 min-h-150 w-220 overflow-y-auto mx-auto mt-10 bg-white p-8 rounded-3xl shadow-xl border border-gray-200">
                    <h2 className="text-4xl font-extrabold mb-6 text-red-600 text-center drop-shadow-sm">
                        Meus Chamados
                    </h2>
                                ...
                                <div className="flex flex-col md:flex-row gap-5">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h1 className="text-3xl font-extrabold text-red-600 drop-shadow-sm">{chamado.titulo}</h1>
                                        </div>
