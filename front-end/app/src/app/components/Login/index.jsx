  ...
  return (
    <section className="w-full h-screen flex flex-row">
      <div className="w-full lg:w-[60%] h-full relative overflow-hidden">
        <div className="lg:hidden absolute inset-0 bg-[url('/red3.png')] bg-cover bg-center z-0" />
        <div className="hidden lg:block h-full">
          <ParticlesFundo />
        </div>
        <div className="lg:hidden w-full h-full flex items-center justify-center p-4 relative z-10">
          <LoginForm />
        </div>
      </div>
