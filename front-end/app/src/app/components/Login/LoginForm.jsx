...
export default function LoginForm() {
  ...
  return (
    <div className="w-[100%] md:w-[40%] bg-white flex items-center justify-center">
      <div className="w-[70%] flex flex-col items-start">
        <Image src="/senai.svg" width={72} height={72} alt="logo" />

        <p className="mt-5 text-[36px] font-bold text-[#525252] mb-2">Faça login</p>
        <form className="w-full" onSubmit={handleLogin}>
          <div className="w-full">
            <label className="text-base font-bold text-[#525252]">Username</label>
            <input
              name="email"
          ...
          <div className="w-full mt-7">
            <label className="text-base font-bold text-[#525252]">Senha</label>
            <input
              type="password"
              name="password"
              placeholder="Senha"
