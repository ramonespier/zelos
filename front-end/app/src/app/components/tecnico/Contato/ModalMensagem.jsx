...
export default function ModalMensagem({ aberto, onClose }) {
    return (
        <AnimatePresence>
            {aberto && (
                <motion.div
                ...
                >
                    ...
                    >
                        <button onClick={onClose} className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 transition cursor-pointer">
                            <FaTimes size={20} />
                        </button>
                        ...
                        <button onClick={onClose} className="mt-2 bg-red-600 text-white py-3 px-6 rounded-xl font-semibold shadow hover:bg-red-700 transition cursor-pointer">
                            Fechar
                        </button>
                    </motion.div>
                </motion.div>
